...
#ifdef RIGIDBOT_DUAL_EXTRUDER
#define X_MAX_POS (X_MAX_BASE - X_DUAL_REDUCTION)
#else
#define X_MAX_POS X_MAX_BASE
#endif
#define X_MIN_POS 0
#define Y_MAX_POS Y_MAX_BASE
#define Y_MIN_POS 0
#define Z_MAX_POS Z_MAX_BASE
#define Z_MIN_POS 0
...
//#define Z_HOME_REST	(Z_MIN_POS + 20)
...
//  #define SDSPEED  SPI_QUARTER_SPEED        //  full/half/quarter/sixteenth, or 0-6 (0 = full speed)
//  #define SDSPEED  SPI_HALF_SPEED        //  full/half/quarter/sixteenth, or 0-6 (0 = full speed)
#endif
